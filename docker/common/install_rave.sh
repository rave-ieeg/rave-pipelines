...
R -q -e 'ravepipeline::pipeline_install_github(repo = "rave-ieeg/rave-pipelines", to = "default", upgrade = FALSE)'

# R -q -e 'ravepipeline::raveio_setopt("data_dir", "/data/rave_data/data_dir")'
# R -q -e 'ravepipeline::raveio_setopt("raw_data_dir", "/data/rave_data/raw_dir")'
# R -q -e 'ravepipeline::raveio_setopt("tensor_temp_path", "/data/rave_data/cache_dir")'
# R -q -e 'ravepipeline::raveio_setopt("threeBrain_template_dir", "/data/rave_data/others/three_brain")'
