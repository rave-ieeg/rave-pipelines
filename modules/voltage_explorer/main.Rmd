...
```{rave prepare_data_repository, language = "R", export = "repository", cue = "always"}
...
```{rave clean_analysis_electrodes, language = "R", export = "analysis_electrodes_clean"}
...
```{rave clean_condition_groups, language = "R", export = "condition_groups_clean"}
...
```{rave prepare_plot_data_placeholder, export = "data_placeholder", cue = "always"}
...
data_by_trial_per_condition <- ravepipeline::pipeline_plot_data(
  x = data_placeholder, name = "data_by_trial_per_condition"
)
...
data_collapse_by_condition <- ravepipeline::pipeline_plot_data(
  x = data_by_trial_per_condition, 
