...
# the intersect handles variables that don't exist
rand_effects <- c('Block', 'Electrode') %>% intersect(names(dd))
fixed_effects <- c('Factor1', 'Factor2', 'Freq', 'Event', 'AnalysisLabel') %>% intersect(names(dd))
...
.datatable.aware=TRUE
    condition_means <- data.table::as.data.table(dd)[ ,list('y'=mean(y), 'se'=rutabaga:::se(y),'n'=.N), keyby=fe]
