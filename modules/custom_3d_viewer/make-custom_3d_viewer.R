...
...targets <- list(`__Check_settings_file` = targets::tar_target_raw("settings_path", 
    ...
    input_analysis_inputs_streamline_collision_detection = targets::tar_target_raw("analysis_inputs_streamline_collision_detection", 
        ...
        }), deps = "settings"), input_streamline_types = targets::tar_target_raw("streamline_types", 
        quote({
            settings[["streamline_types"]]
        ...
        }), deps = "settings"), input_coordinate_sys = targets::tar_target_raw("coordinate_sys", 
        quote({
        ...
        command = quote({
            ...
            "coordinate_sys", "use_template")), deps = c("subject_code", 
        "project_name", "overlay_types", "surface_types", "annot_types", 
        "streamline_types", "use_spheres", "override_radius", 
        "coordinate_sys", "use_template"), cue = targets::tar_cue("always"), 
